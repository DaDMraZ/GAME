...
Button btn0 = {280, 90, 200, 45, "Старт", true};
Button btn1 = {280, 155, 200, 45, "Настройки", true};
Button btn2 = {280, 220, 200, 45, "Правила", true};
Button btn3 = {280, 285, 200, 45, "О Разработчике", true};
Button btn4 = {280, 360, 200, 45, "Выход", true};
